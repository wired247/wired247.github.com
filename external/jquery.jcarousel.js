...
(function($) {
    ...
    $.jcarousel = function(e, o) {
        ...
        if (!this.buttonPrev.length && this.options.buttonPrevHTML !== null) {
		...
		//if (this.buttonNext.size() === 0 && this.options.buttonPrevHTML !== null) {
        if (!this.buttonNext.length && this.options.buttonNextHTML !== null) {
    ...
    $jc.fn.extend({
        ...
        buttons: function(n, p) {
            ...
            if (this.buttonNext.length && this.buttonNext.length > 0) {
            ...
            if (this.buttonPrev.length && this.buttonPrev.length > 0) {
